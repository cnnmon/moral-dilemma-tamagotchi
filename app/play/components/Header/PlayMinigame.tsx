  ...
  return (
    <div className="flex w-full h-50">
      ...
      >
        <div
          ref={gameAreaRef}
          className="relative w-full h-40 bg-zinc-50 border-2 border-zinc-300 cursor-none overflow-hidden"
        ...
        >
          {!gameStarted ? (
            ...
            <>
              {/* Ball */}
              <div
                className="absolute bg-orange-500 rounded-full transition-none"
                style={{
                  left: `${ballPosition.x}%`,
                  top: `${ballPosition.y}%`,
                  width: `${ballSize}%`,
        ...
        <div className="flex justify-between items-center mt-2">
          <p className="text-sm text-zinc-600">Bounces: {bounceCount}/2</p>
          <p className="text-sm text-zinc-600">
            {gameStarted ? "Move mouse to control paddle" : "Click to start"}
          </p>
        </div>
      </Window>
    </div>
