...
export const stage1Evolutions: Record<Stage1EvolutionId, Stage1Evolution> = {
  ...
  [EvolutionId.EMPATH]: {
    ...
    nextStages: {
      [attributes[MoralDimensions.devotion].low]: `${EvolutionId.CULTLEADER}_empath`,
      [attributes[MoralDimensions.devotion].high]: `${EvolutionId.SAINT}_empath`,
    },
  },
  ...
  [EvolutionId.DEVOUT]: { 
    ...
    nextStages: {
      [attributes[MoralDimensions.retribution].high]: `${EvolutionId.GAVEL}_devout`,
      [attributes[MoralDimensions.retribution].low]: `${EvolutionId.SAINT}_devout`,
    },
  },
  ...
  [EvolutionId.TEACHERSPET]: { 
    ...
    nextStages: {
      [attributes[MoralDimensions.purity].high]: `${EvolutionId.SAINT}_soldier`,
  ...
  [EvolutionId.HEDONIST]: { 
    ...
    nextStages: {
      ...
      [attributes[MoralDimensions.compassion].high]: `${EvolutionId.CULTLEADER}_${EvolutionId.HEDONIST}`,
    },
  },
...
export const evolutionToStat = {
  ...
  [EvolutionId.TEACHERSPET]: "high devotion",
  [EvolutionId.HEDONIST]: "high ego",
  [EvolutionId.NPC]: "balanced traits",
  [EvolutionId.GAVEL]: "high retribution + high dominance",
  [EvolutionId.VIGILANTE]: "high retribution + low dominance", 
  [EvolutionId.GODFATHER]: "high dominance + high ego",
  [EvolutionId.GUARDIAN]: "high dominance + low ego",
  [EvolutionId.ARISTOCRAT]: "high devotion + low purity",
  [EvolutionId.SIGMA]: "high ego + low compassion",
  [EvolutionId.SAINT]: "high virtue + sacrifice",
  [EvolutionId.CULTLEADER]: "high charisma + manipulation",
